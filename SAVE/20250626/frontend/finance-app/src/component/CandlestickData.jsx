...
function Candlestick ({dateData, mouseX, mouseY, setMouseX, setMouseY, min, max, isAnnotationDisplay, setIsAnnotationDisplay}) {
    ...
    useEffect(() => {
        const fetchData = async () => {
            setClose(await getCloseData());
            setOpen(await getOpenData());
            setMaxList(await getMaxData());
            setMinList(await getMinData());
        };
